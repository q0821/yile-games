...
> 2026-09-22 更新：舊題庫授權鏈未確認，已在本機改為暫停入口並排除新版建置資產，尚未部署。原始題目與既有進度保留。以 [授權盤點](docs/TSUMEGO-LICENSE-AUDIT.md) 及 [第二階段規格](docs/PRD-go-learning-followup.md) 為準；以下功能紀錄屬歷史狀態。
...
> - 死活模式與二選一首頁**均已出貨**。
> - **題庫規模超出原訂「50 題 MVP」**：實際匯入 20 個題集子目錄，含趙治勳 2,539 題與其他題集 1,369 題，
...
| 項目 | 決定 |
|------|------|
| 題庫來源 | **sanderland/tsumego**（GitHub，上游程式 MIT；題目內容授權待確認） |
...
| 授權義務 | 把題庫檔放進 repo 時，**一併保留原 repo 的 LICENSE**（保留上游程式署名，不代表原題授權）。舊決定已由 2026-09-22 暫停提供取代 |
